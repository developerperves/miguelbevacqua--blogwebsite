...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
        ...
        <span class="breadcrumb-item active"><a href="{{ route('home.partner.index') }}">Partner</a></span>
    </nav>
                ...
                <div class="col-lg-8">
                    ...
                    <table class="table table-bordered" id="product_table">
                        ...
                        <td>
                                ...
                                <td>
                                    <a href="{{ route('home.partner.edit', $data->id) }}"
                                        class="btn btn-sm btn-primary">Update</a>
                                    <form action="{{ route('home.partner.destroy', $data->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="admin-form" action="{{ route('home.partner.store') }}" method="POST"

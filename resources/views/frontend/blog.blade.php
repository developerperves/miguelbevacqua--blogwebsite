...
background-image: url({{ $setting->blog_banner_bg ? asset('assets/images/'.$setting->blog_banner_bg) : asset('assets/images/placeholder.png') }});">
    ...
    <div class="akea-page-title-container akea-container">
        <div class="akea-page-title-content akea-item-pdlr">
            <h3 class="akea-page-title">{{ $setting->blog_banner_heading }}</h3>
                            ...
                            @foreach ($blogs as $blog)
                                <div
                                    ...
                                    <div class=gdlr-core-blog-full-content-wrap>
                                            ...
                                            <div class=gdlr-core-blog-full-head-right>
                                                ...
                                                <div class="gdlr-core-blog-info-wrapper gdlr-core-skin-divider">
                                                    <span
                                                        ...
                                                        <a href="{{ route('front.blog.detail', $blog->slug) }}" title="Posts by Kally Gordon" rel=author>Admin</a>
                                                    </span>
                                                    <span
                                        ...
                                        <div class=gdlr-core-blog-content><a style="color: inherit;" href="{{ route('front.blog.detail', $blog->slug) }}">{{ strlen(strip_tags($blog->details)) > 250 ? substr(strip_tags($blog->details), 0, 250) : strip_tags($blog->details) }}...</a><a href="{{ route('front.blog.detail', $blog->slug) }}">read more</a></div>
                                    </div>
                                </div>
                                <hr />
                            @endforeach
                        ...
                        <div class="gdlr-core-recent-post-widget clearfix">
                            <div
                                ...
                                <img src="{{ $popular->thumbnail ? asset('assets/images/'.$popular->thumbnail) : asset('assets/images/placeholder.png') }}" alt="{{ asset('assets/images/'.$popular->thumbnail) }}"
                                    width=50 height=50 style="height: 50px!important; width:50px !important" title=qingbao-meng-330658-unsplash></div>
                                                    ...
                                                    <div id=gdlr-core-category-background-widget-2
                                                        ...
                                                        <ul class=gdlr-core-category-background-widget>
                                                            ...
                                                            <li class=gdlr-core-with-bg
                                                                ...
                                                                <a href={{ route('category.name', $category->name) }}><span
